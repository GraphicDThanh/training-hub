# Exercise 2
# If you download my solution to Exercise 2 from http://thinkpython2.com/code/anagram_sets.py,
# you’ll see that it creates a dictionary that maps from a sorted string of letters
