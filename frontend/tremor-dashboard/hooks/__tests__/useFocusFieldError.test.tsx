...
describe("Test useFocusFieldError hook", () => {
  it("Should check none error message and no focus to input filed", async () => {
    ...
    jest.requireMock("react-hook-form").Controller = (
      ...
      return props.render(
        mockControllerNoneError(props.name, props.rule as Object),
      );
    };
  ...
  it("Should show error message when has error message and focus to it", async () => {
    ...
    jest.requireMock("react-hook-form").Controller = (
      ...
      return props.render(
        mockControllerHasError(props.name, props.rule as Object),
      );
    };
    ...
    const { getAllByText } = render(
      <Controller
        ...
        render={({ field, formState: { errors } }) => {
          const priceErrorMessage = errors.message?.toString();
