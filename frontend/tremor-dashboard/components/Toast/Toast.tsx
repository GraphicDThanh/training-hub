...
const Toast = ({ icon, message, color = "green", onClose }: ToastProps) => {
  return (
    <div
      className="fixed z-[9999] right-5 top-5 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
      role="alert"
      data-testid="toast">
      <div
      ...
      <div className="ms-3 text-sm font-normal" data-testid="messageToast">
        {message}
      </div>
      <Button
        type="button"
