...
// Components
import { DataGrid, CustomAvatarName, CustomNumberFormat } from "@/components";
...
const columns: ColumnType<Product>[] = [
  {
    ...
    customNode: (_, { id }) => (
      <Link
        ...
        className="text-xs dark:text-lighter text-tertiary font-semibold leading-[15px] tracking-[0.4px] order-id hover:underline">
        &#35;{id}
      </Link>
    ),
  },
...
const OtherProducts = ({ products }: { products: Product[] }) => (
  <DataGrid
    data={products}
    columns={columns}
