...
const TrackOrder = ({
  ...
  const trackingOrder = (status: number, date: string) => {
    switch (status) {
      case 0:
        return (
          <div className="flex items-start pl-2 pr-6 pt-6 leading-[1.3rem] after:line-content">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-tremor-label text-tertiary uppercase font-light dark:text-dark-romance">
                {formatDateTime(date)}
              </span>
            </div>
          </div>
      ...
      case 2:
        return (
          <div className="flex cursor-pointer items-start pl-2 pr-6 pt-6 leading-[1.3rem] after:line-content">
            <span className="mr-3 flex h-8 w-8 min-w-[32px] mt-1 items-center justify-center rounded-full text-lg font-medium text-dark-primary bg-slate-500">
              <RiRefund2Line />
            </span>
            <div className="flex flex-col">
              <span className="text-tremor-default text-primary font-semibold after:absolute after:flex after:text-[0.8rem] dark:text-dark-primary">
  ...
  return (
    <>
      ...
      <ul className="relative m-0 w-full p-0 pb-6 tracking-[0.4px]">
        <li className="relative h-fit after:absolute after:left-[1.45rem] after:top-[3.6rem] after:mt-[5px] after:line-track after:w-[0.125rem] after:bg-select after:line-content">
          <div className="flex items-start pl-2 pr-6 pt-6 leading-[1.3rem] after:line-content">
            <span className="mr-3 flex h-8 w-8 min-w-[32px] mt-1 items-center justify-center rounded-full bg-tremor-content text-sm font-medium text-white">
              <FaBell />
            </span>
            <div className="flex flex-col">
              <span className="text-tremor-default text-primary font-semibold after:absolute after:flex after:text-[0.8rem] dark:text-dark-primary">
        ...
        <li className="1234 relative h-fit after:absolute after:left-[1.45rem] after:top-[3.6rem] after:mt-[5px] after:line-track after:w-[0.125rem] after:bg-select after:content-empty">
          <div className="flex items-start pl-2 pr-6 pt-6 leading-[1.3rem] after:line-content">
            <span className="mr-3 flex h-8 w-8 min-w-[32px] mt-1 items-center justify-center rounded-full bg-tremor-content text-sm font-medium text-white">
              <IoCart />
            </span>
            <div className="flex flex-col">
              ...
              <span className="text-tremor-label text-primary uppercase font-light dark:text-dark-romance">
                {formatDateTime(transmittedToCourierAt)}
              </span>
            </div>
          </div>
        </li>
