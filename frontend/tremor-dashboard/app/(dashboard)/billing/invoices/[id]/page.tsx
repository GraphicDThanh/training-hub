...
import { InvoiceHeader } from "@/features/invoices";
const InvoiceBody = dynamic(
  () => import("@/features/invoices/InvoiceBody/InvoiceBody"),
);
const InvoiceFooter = dynamic(
  () => import("@/features/invoices/InvoiceFooter/InvoiceFooter"),
);
...
const InvoiceDetailsPage = async ({ params }: { params: { id: number } }) => {
  ...
  return (
    <Flex
      ...
      as="main">
      <Card
        className="print-content w-full lg:w-2/3 dark:bg-dark-blue px-6 py-7 ring-0 rounded-xl shadow-md print:shadow-none dark:print:shadow-none"
        id="print-content">
