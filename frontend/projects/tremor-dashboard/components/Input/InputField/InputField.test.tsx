...
describe("Test InputField component", () => {
  ...
  it("should call onBlur handler with correct parameters", () => {
    const onBlurMock = jest.fn();

    const { getByLabelText } = render(
      <InputField id="test-input" label="Test Input" onBlur={onBlurMock} />,
    );

    const inputElement = getByLabelText("Test Input");

    fireEvent.blur(inputElement, { target: { value: "test value" } });
