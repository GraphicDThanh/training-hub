const WorldMapCanvas = () => (
  <svg className="flex justify-center items-center w-[270px] h-[136px] md:h-[175px] lg:w-[480px] lg:h-[245px] mt-0 md:-mt-10 ">
    <g
      id="jvm-regions-group"
      className="scale-[22%] md:scale-[28%] lg:scale-[42%] translate-x-[5%] md:translate-x-2 lg:translate-x-16 translate-y-0">
      <path
