  ...
  return (
    <TableRow
      ...
      <TableCell className="px-4 py-3 w-6/12 w-[25%]">
        <Flex>
          ...
          <Flex alignItems="start" className="flex-col ml-6">
            <Text className="text-xs text-tremor-content-emphasis dark:text-dark-romance font-semibold leading-[1.25] tracking-[0.03333em]">
              Country:
            </Text>
      ...
      <TableCell className="px-4 py-3 text-left w-[25%]">
        <Text className="text-left text-xs text-tremor-content-emphasis dark:text-dark-romance font-semibold leading-[1.25]">
          Sales:
        </Text>
      ...
      {isAnalytics && (
        <TableCell className="px-4 py-3 text-left value w-[25%]">
          <Text className="text-xs text-tremor-content-emphasis dark:text-dark-romance font-semibold leading-[1.25]">
            Value:
          </Text>
...
export default memo(SalesByCountryRow);
