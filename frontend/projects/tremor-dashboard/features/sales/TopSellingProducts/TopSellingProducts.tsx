...
// Constants
import { CURRENCY, TOP_SELLING_PRODUCTS_IMAGE } from "@/constants";
...
const TopSellingProducts = ({ title, data }: TopSellingProductsProps) => (
  <Card className="p-0 border-none ring-0 dark:bg-dark-tremor-primary">
    <Flex>
      <h2 className="p-5 pb-2.5 text-sm md:text-base font-bold text-primary dark:text-dark-primary">
        {title}
      </h2>
    </Flex>
                    ...
                    <Flex>
                      <Flex className="w-16 mr-3 md:mr-1">
                        <CustomImage
                          ...
                          src={TOP_SELLING_PRODUCTS_IMAGE[productId]}
                          width={48}
                          height={48}
                          alt={name}
                          priority
                      ...
                      <Flex alignItems="start" flexDirection="col">
                        ...
                        <Text className="text-tertiary dark:text-greyer leading-[21px] tracking-[0.4px] product-orders">
                          <span className="text-greener dark:text-few">
                            {formattedNumber({
                              value: orders,
                  ...
                  <TableCell className="px-6 py-3">
                    <Flex justifyContent="start">
                      ...
                      {refundsType === "increase" ? (
                        <MdKeyboardArrowUp className="text-xl text-few dark:text-few" />
                      ) : (
