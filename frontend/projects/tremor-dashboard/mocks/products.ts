...
export const MOCK_PRODUCT_IMAGE = {
  ...
  desc: "The place is close to Barceloneta Beach and bus stop just 2 min by walk and near to “Navig” where you can enjoy the main night life in Barcelona.",
  image:
...
export const MOCK_PRODUCT_SOCIAL = {
  shopifyUrl: "https://shopify-url.com",
...
export const MOCK_PRICING_INFO = {
  price: "90",
  type: "USD",
  sku: "71283476591",
  tags: [""],
...
export const MOCK_PRODUCT_INFO_DETAIL = {
  id: 230019,
  productName: "Minimal Bar Stool",
  description:
    "Long sleeves black denim jacket with a twisted design. Contrast stitching. Button up closure. White arrow prints on the back.",
...
export const MOCK_PRODUCTS_SHORTER_FORM = [
  {
    id: 1,
