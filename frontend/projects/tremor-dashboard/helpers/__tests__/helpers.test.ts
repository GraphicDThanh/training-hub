...
describe("Test handleMatchPath function", () => {
  it("Should render Product Details", () => {
    const result = handleMatchPath("http://localhost:3000/products/87120");
    expect(result).toBe("Product Details");
  });

  it("Should render Order Details", () => {
    const result = handleMatchPath("http://localhost:3000/orders/87120");
...
describe("Test updateClassIconBySort function", () => {
  const mockProps = {
    keyColumn: "id",
    sortField: "id",
    sortType: "asc",
  ...
  it("Should render correct class icon while asc", () => {
    const result = updateClassIconBySort({ ...mockProps });
    expect(result).toBe("text-primary");
  });

  it("Should render correct class icon while desc", () => {
    const result = updateClassIconBySort({ ...mockProps, typeOfIcon: "desc" });
    expect(result).toBe("fill-secondary");
  });
});
...
describe("formatDateTime function", () => {
  it("should format date and time without separator", () => {
    ...
    expect(formattedDate).toBe("Jan 23, 2022 12:34 PM");
  });
});
...
describe("formatNewDate function", () => {
  it("should format date and time without separator", () => {
    ...
    expect(formattedDate).toBe("Jan 23, 2022");
  });
});
