export const color = {
  ...
  greyer: "#b0b5bf",
  grayLight: "#191919",
  // ref name from https://www.color-name.com/hex/87bae8
  "jordy-blue": "#87bae8",
  silver: "#acacb4",
...
export const backgroundImage = {
  ...
  "gradient-seldom":
    "linear-gradient(90deg, rgba(52, 71, 103, 0), rgba(52, 71, 103, .4), rgba(52, 71, 103, 0))",
  "gradient-primary":
  ...
  "auth-image":
    "linear-gradient(195deg,rgba(66,66,74,0.6),rgba(25,25,25,0.6)),url('/assets/images/bg-sign-in.webp')",
  "project-layer":
    "linear-gradient(195deg,rgba(73,163,241,0.6),rgba(26,115,232,0.6))",
...
export const boxShadow = {
  ...
  "btn-surface":
    "rgba(240, 242, 245, 0.15) 0rem 0.1875rem 0.1875rem 0rem, rgba(240, 242, 245, 0.2) 0rem 0.1875rem 0.0625rem -0.125rem, rgba(240, 242, 245, 0.15) 0rem 0.0625rem 0.3125rem 0rem",
  "btn-surface-hover":
    "rgba(240, 242, 245, 0.4) 0rem 0.875rem 1.625rem -0.75rem, rgba(240, 242, 245, 0.15) 0rem 0.25rem 1.4375rem 0rem, rgba(240, 242, 245, 0.2) 0rem 0.5rem 0.625rem -0.3125rem",
  "box-header-sticky":
    "rgba(255, 255, 255, 0.9) 0rem 0rem 0.0625rem 0.0625rem inset, rgba(0, 0, 0, 0.05) 0rem 1.25rem 1.6875rem 0rem",
  "tremor-chat": "rgba(100, 100, 111, 0.5) 0px 7px 29px 0px",
  "box-avatar": "0 0 1px rgba(100, 100, 111, 0.5)",
  // dark
  "dark-tremor-input": "",
  "dark-tremor-card":
