...
import { ThumbnailModalStyled } from '../styles/ModalStyled';
import Input from '../../commons/components/input/Input';
import Button from '../../commons/components/button/Button';
import CustomFileInput from '../../commons/components/input/CustomFileInput';
...
class ProductForm extends Component {
  ...
  handleSubmit = (e) => {
    ...
    if (!error) {
      ...
      let oldDataProduct = this.props.data;
      // close popup after submit
      this.props.toggleModal();

      // must remove error data when build save product
      if (!oldDataProduct ||
        oldDataProduct.id !== state.id ||
        oldDataProduct.name !== state.name ||
        oldDataProduct.price !== state.price ||
        oldDataProduct.price !== state.price) {
