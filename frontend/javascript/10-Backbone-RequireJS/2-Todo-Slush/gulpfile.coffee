...
gulp.task 'html', ['jade'], ->
  gulp.src paths.src + '/*.html'
    ...
    .pipe $.replace 'assets/vendor/requirejs-hbs/example/assets/lib/require.js', 'assets/js/require.js'
    .pipe $.htmlmin
      removeComments: true
...
gulp.task 'rename', ['rjs'], ->
  gulp.src paths.script + '/main-built.js'
    ...
    .pipe gulp.dest 'dist'
  gulp.src paths.vendor + '/requirejs-hbs/example/assets/lib/require.js'
    .pipe $.uglify()
...
# Command line run: gulp release --env production
