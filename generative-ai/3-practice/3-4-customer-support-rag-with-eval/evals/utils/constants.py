# FAQs
EVALS_FAQS_VECTOR_STORE_PATH = "db/embeddings/evals/faqs_vector_store"
EVALS_FAQS_VECTOR_STORE_COLLECTION_NAME = "evals_faqs_collections"

# Policies
EVALS_POLICIES_VECTOR_STORE_PATH = "db/embeddings/evals/policies_vector_store"
EVALS_POLICIES_VECTOR_STORE_COLLECTION_NAME = "evals_policies_collections"

# Information
EVALS_INFORMATION_VECTOR_STORE_PATH = "db/embeddings/evals/information_vector_store"
EVALS_INFORMATION_VECTOR_STORE_COLLECTION_NAME = "evals_information_collections"

# Products
EVALS_PRODUCTS_VECTOR_STORE_PATH = "db/embeddings/evals/products_vector_store"
EVALS_PRODUCTS_VECTOR_STORE_COLLECTION_NAME = "evals_products_collections"


# Create and label dataset
# prompt_create_eval_dataset = """You are an expert at creating datasets that can be used to evaluate LLM prompts. You are very intelligent and detail-oriented, and create ecommerce critical datasets that can be relied upon for characterizing and improving LLM-based systems.
...
## Role
You are an expert in creating e-commerce datasets to evaluate LLM prompts. Your task is to design precise and reliable test cases.

## Tasks:
1. Review Context:
- Analyze "task_context", "new_input_case", and "example_inputs".
- Match the style, tone, and format of "example_inputs".
- Copy "new_input_case" as-is into the output JSON.
2. Generate Output:
- Provide a brief "rationale".
- Create a new "input" based on the task context.
- Fill "output_columns" with correct values or "Not Found".
...
```json
{
  ...
  "input": "Generated input query.",
  "user_query": "String value",
  "context": "String value or 'Not Found'",
  "response": "String value or 'Not Found'"
}
```
"""
