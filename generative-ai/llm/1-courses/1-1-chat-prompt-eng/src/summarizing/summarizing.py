def summarize(get_completion):
    ...
    # but smaller than expected for the price. \
    # Arrived early, with a friendly face.
    ...
    """
    # response:
    # The product arrived a day early, \
    # allowing for personal inspection before gifting. \
    # Consider offering larger options for the same price.
    ...
    """
    # response:
    # The panda plush toy is soft, cute, and loved by the daughter.
    # However, the size may not justify the price compared to
    # other options. Arrived early.
    ...
    """
    # response:
    # Feedback: The customer received the product a day earlier
    # than expected, which was a positive experience.
    # Consider offering larger options for the same price
    ...
    # response:
    # Review 1:
    # Panda plush toy is soft, cute, and loved by daughter,
    # but smaller than expected for the price.

    # Review 2:
    # Great lamp with storage, fast delivery,
    # excellent customer service for missing parts.
    # Company cares about customers.

    # Review 3:
    # Impressive battery life, small head size, good deal for $50,
    # generic replacement heads available, leaves teeth feeling clean.

    # Review 4:
    # Mixed feelings about price changes,
    # quality decline, and motor issues after a year of use.
    # Fast delivery.