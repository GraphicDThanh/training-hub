...
client = Client()
dataset_name = "IVY Moda Golden Data Set"
evaluate(
    target_function,
    data=dataset_name,
    evaluators=[compare_semantic_similarity, is_concise_enough, latency_evaluator],
    experiment_prefix="IVY Moda Golden Data Set Experiment",
)

# # TASK: Run 1 example with ID
# # "IVY Moda Golden Data Set"
# dataset_id = "b111ef6d-85cb-42fe-a91c-909bfc8c7e60"
# # Give me list of policies
# example_id = "848b0998-7ee3-415c-b1ab-41ff80717dde"
